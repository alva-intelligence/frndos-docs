...
const PostCollection = {
  ...
  fields: [
    ...
    },
    {
      ...
      description: "Link this changelog entry to the help article for the feature.",
      collections: ["doc"],
    },
    {
      type: "rich-text",
...
const DocsCollection = {
  ...
  fields: [
    ...
    },
    {
      ...
      name: "description",
      label: "Description",
      description: "Short summary shown in article lists and search results.",
    },
    {
      type: "string",
      name: "module",
      label: "frndOS Module",
      description: "Which frndOS module this article documents.",
      options: [
